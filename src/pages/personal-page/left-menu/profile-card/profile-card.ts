...
export default class ProfileCard extends BaseComponent<'div'> {
  private photo: BaseComponent<'div'> = new BaseComponent('div', this.element, 'profile-card-photo');
  ...
  private render(photo: string, name: string, about: string): void {
    ...
    this.name = new BaseComponent('h4', this.element, 'profile-card-name', name);
    this.about = new BaseComponent('p', this.element, 'profile-card-about', about);
    this.profileScore = new BaseComponent('div', this.element, 'profile-card-info');
